...
- `CLAUDE.md` dosyasındaki `MyDailyNotes - Elit Kişisel Günlük ve Akıllı Not Defteri`, `MyDailyNotes - Elit Kişisel Günlük ve Akıllı Not Defteri — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
